    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link" href="{{ url('doctors','show') }}">
                    <div class="sb-nav-link-icon"><i class="fas fa-user-md"></i></div>
                    Show Doctors
                </a>
                <a class="nav-link" href="{{ url('doctors_create') }}">
                    <div class="sb-nav-link-icon"><i class="fa fa-plus"></i></div>
                    Add Doctors
                </a>
                <a class="nav-link" href="{{ url('doctors','modify') }}">
                    <div class="sb-nav-link-icon"><i class="fas fa-edit"></i></div>
                    Modify Doctors
                </a>
                <a class="nav-link" href="{{ url('doctors','delete') }}">
