                    ...
                    <div class="container mt-5 align-middle w-50">
                        ...
                        <form action="{{ url('doctors_store') }}" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group my-4">
                                ...
                                <input type="text" class="form-control" id="medical_licence_number" name="medical_licence_number" required="" style="color:black">
                            </div>


                            <div class="form-group my-4">
                                <label for="profile_image">Profile Image:</label>
                                <input type='file' onchange="readURL(this);" id="profile_image" name="profile_image" required="" />
                                <img id="blah" src="http://placehold.it/180" alt="your image" class="form-control-file pb-5" />
                            </div>
